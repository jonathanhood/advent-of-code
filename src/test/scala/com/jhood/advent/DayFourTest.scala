...
import org.jhood.advent.DayFour._
import org.scalatest.FunSuite

class DayFourTest extends FunSuite {
  test("part 1 - parse the example log") {
    val log =
      """
    ...
    val result = LogParser.parse(log)
    assert(exampleLog == result)
  }

  test("part 1 - solve the example") {
    val concentration = sleepConcentration(exampleLog)
    assert(asleepMost(concentration) == 10)
    assert(asleepMostAt(concentration, 10) == 24)
    assert(solvePart1(exampleLog) == 240)
  }

  test("part 1 - pass the test") {
    val log = LogParser.parse(input)
    val result = solvePart1(log)
    println(s"Day 4 Part 1 - $result")
  }

  test("part 2 - solve the example") {
    assert(solvePart2(exampleLog) == 4455)
  }

  test("part 2 - pass the test") {
    val log = LogParser.parse(input)
    val result = solvePart2(log)
    println(s"Day 4 Part 2 - $result")
  }

  val exampleLog = List(
    Begins(LocalDateTime.of(1518, 11, 1, 0, 0), 10),
    Asleep(LocalDateTime.of(1518, 11, 1, 0, 5), 10),
    Wakes(LocalDateTime.of(1518, 11, 1, 0, 25), 10),
    Asleep(LocalDateTime.of(1518, 11, 1, 0, 30), 10),
    Wakes(LocalDateTime.of(1518, 11, 1, 0, 55), 10),

    Begins(LocalDateTime.of(1518, 11, 1, 23, 58), 99),
    Asleep(LocalDateTime.of(1518, 11, 2, 0, 40), 99),
    Wakes(LocalDateTime.of(1518, 11, 2, 0, 50), 99),

    Begins(LocalDateTime.of(1518, 11, 3, 0, 5), 10),
    Asleep(LocalDateTime.of(1518, 11, 3, 0, 24), 10),
    Wakes(LocalDateTime.of(1518, 11, 3, 0, 29), 10),

    Begins(LocalDateTime.of(1518, 11, 4, 0, 2), 99),
    Asleep(LocalDateTime.of(1518, 11, 4, 0, 36), 99),
    Wakes(LocalDateTime.of(1518, 11, 4, 0, 46), 99),

    Begins(LocalDateTime.of(1518, 11, 5, 0, 3), 99),
    Asleep(LocalDateTime.of(1518, 11, 5, 0, 45), 99),
    Wakes(LocalDateTime.of(1518, 11, 5, 0, 55), 99),
  )
